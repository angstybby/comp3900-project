...
export default function Profile() {
  ...
  return (
    <Menu as="div" className="relative inline-block w-full text-left mt-auto bg-white hover:bg-gray-50">
      ...
      >
        <MenuItems anchor="top" className="absolute right-0 z-[60] mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
          <div className="py-1">
            <MenuItem>
              {({ focus }) => (
                <a
